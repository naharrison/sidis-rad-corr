...
c of parton distribution and fragmentation functions
      ...
      double precision h3,h4,qm,t,pi_thresh,r,xi,Ebeam,cterm,m_cos_phi,m_cos_2phi
      integer ih,nc,GPDF,SPDF,IFINI,ISET,ICHARGE
      data ac/1.2025D-10/,bc/-5.2703D-02/,cc/3.7467D-01/,
     &dc/6.5397D-02/,ec/-2.2136D-01/,fc/-1.0621D-01/
      data rlt/0.14d0/
...
c      if(Ebeam.eq.27.d0) print*,'<cos(phi)> ',m_cos_phi
      if(abs(2.d0*m_cos_phi).gt.0.9d0) stop
